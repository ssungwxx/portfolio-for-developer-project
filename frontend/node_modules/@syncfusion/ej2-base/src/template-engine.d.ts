...
export declare function updateBlazorTemplate(templateId?: string, templateName?: string, comp?: object): void;
export declare function resetBlazorTemplate(templateId?: string, templateName?: string): void;
/**
