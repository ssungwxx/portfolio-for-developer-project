@include export-module('input-theme') {
  ...
  .e-input + .e-input-group-icon:not(.e-input-group.e-float-icon-left):last-child:hover,
  ...
  textarea.e-input#{$css}:hover:not(.e-success):not(.e-warning):not(.e-error):not([disabled]) {
    @if $input-skin-name == 'fabric' or $input-skin-name == 'bootstrap' {
      border-color: $input-group-border-color-hover;
    }
  }
  ...
  .e-float-input.e-control-wrapper:hover:not(.e-input-group):not(.e-success):not(.e-warning):not(.e-error):not(.e-disabled) input:not([disabled]),
  .e-float-input.e-control-wrapper:hover:not(.e-input-group):not(.e-success):not(.e-warning):not(.e-error):not(.e-disabled) textarea:not([disabled]) {
    @if $input-skin-name != 'material' and $input-skin-name != 'bootstrap' and $input-skin-name != 'bootstrap4' and $input-skin-name != 'highcontrast' {
      border-color: $input-group-border-color-hover;
    }
  }
  ...
  .e-filled.e-float-input:not(.e-error) input:not(:focus):valid ~ label.e-float-text.e-label-bottom,
  .e-filled.e-float-input.e-control-wrapper:not(.e-error) input:not(:focus):valid ~ label.e-float-text.e-label-bottom,
  .e-filled.e-float-input.e-bigger:not(.e-error) input:not(:focus):valid ~ label.e-float-text.e-label-bottom,
  .e-filled.e-float-input.e-control-wrapper.e-bigger:not(.e-error) input:not(:focus):valid ~ label.e-float-text.e-label-bottom,
  .e-bigger .e-filled.e-float-input:not(.e-error) input:not(:focus):valid ~ label.e-float-text.e-label-bottom,
  .e-bigger .e-filled.e-float-input.e-control-wrapper:not(.e-error) input:not(:focus):valid ~ label.e-float-text.e-label-bottom,
  .e-filled.e-float-input.e-small:not(.e-error) input:not(:focus):valid ~ label.e-float-text.e-label-bottom,
  .e-filled.e-float-input.e-control-wrapper.e-small:not(.e-error) input:not(:focus):valid ~ label.e-float-text.e-label-bottom,
  .e-small .e-filled.e-float-input:not(.e-error) input:not(:focus):valid ~ label.e-float-text.e-label-bottom,
  .e-small .e-filled.e-float-input.e-control-wrapper:not(.e-error) input:not(:focus):valid ~ label.e-float-text.e-label-bottom,
  .e-filled.e-float-input.e-small.e-bigger:not(.e-error) input:not(:focus):valid ~ label.e-float-text.e-label-bottom,
  .e-filled.e-float-input.e-control-wrapper.e-small.e-bigger:not(.e-error) input:not(:focus):valid ~ label.e-float-text.e-label-bottom,
  .e-bigger .e-filled.e-float-input.e-small:not(.e-error) input:not(:focus):valid ~ label.e-float-text.e-label-bottom,
  .e-bigger .e-filled.e-float-input.e-control-wrapper.e-small:not(.e-error) input:not(:focus):valid ~ label.e-float-text.e-label-bottom {
    @if $input-skin-name == 'material' {
  ...
  .e-filled.e-float-input:not(.e-error) input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-bigger .e-filled.e-float-input:not(.e-error) input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-bigger.e-filled.e-float-input:not(.e-error) input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-small .e-filled.e-float-input:not(.e-error) input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-small.e-filled.e-float-input:not(.e-error) input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-bigger .e-filled.e-float-input.e-small:not(.e-error) input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-bigger.e-small .e-filled.e-float-input:not(.e-error) input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-filled.e-float-input.e-bigger.e-small:not(.e-error) input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-filled.e-float-input.e-control-wrapper.e-autofill:not(.e-error) input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-bigger .e-filled.e-float-input.e-control-wrapper.e-autofill:not(.e-error) input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-bigger.e-filled.e-float-input.e-control-wrapper.e-autofill:not(.e-error) input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-small .e-filled.e-float-input.e-control-wrapper.e-autofill:not(.e-error) input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-small.e-filled.e-float-input.e-control-wrapper.e-autofill:not(.e-error) input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-bigger .e-filled.e-float-input.e-small.e-control-wrapper.e-autofill:not(.e-error) input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-bigger.e-small .e-filled.e-float-input.e-control-wrapper.e-autofill:not(.e-error) input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-filled.e-float-input.e-bigger.e-small.e-control-wrapper.e-autofill:not(.e-error) input:not(:focus):-webkit-autofill~label.e-float-text {
    @if $input-skin-name == 'material' {
      color: $filled-input-float-label-color;
    }
  }
  ...
  .e-filled.e-float-input.e-success input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-bigger .e-filled.e-float-input.e-success input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-bigger.e-filled.e-float-input.e-success input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-small .e-filled.e-float-input.e-success input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-small.e-filled.e-float-input.e-success input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-bigger .e-filled.e-float-input.e-small.e-success input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-bigger.e-small .e-filled.e-float-input.e-success input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-filled.e-float-input.e-bigger.e-small.e-success input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-filled.e-float-input.e-control-wrapper.e-autofill.e-success input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-bigger .e-filled.e-float-input.e-control-wrapper.e-autofill.e-success input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-bigger.e-filled.e-float-input.e-control-wrapper.e-autofill.e-success input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-small .e-filled.e-float-input.e-control-wrapper.e-autofill.e-success input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-small.e-filled.e-float-input.e-control-wrapper.e-autofill.e-success input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-bigger .e-filled.e-float-input.e-small.e-control-wrapper.e-autofill.e-success input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-bigger.e-small .e-filled.e-float-input.e-control-wrapper.e-autofill.e-success input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-filled.e-float-input.e-bigger.e-small.e-control-wrapper.e-autofill.e-success input:not(:focus):-webkit-autofill~label.e-float-text {
    @if $input-skin-name == 'material' {
      color: $input-success-color;
    }
  }
  ...
  .e-filled.e-float-input.e-warning input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-bigger .e-filled.e-float-input.e-warning input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-bigger.e-filled.e-float-input.e-warning input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-small .e-filled.e-float-input.e-warning input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-small.e-filled.e-float-input.e-warning input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-bigger .e-filled.e-float-input.e-small.e-warning input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-bigger.e-small .e-filled.e-float-input.e-warning input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-filled.e-float-input.e-bigger.e-small.e-warning input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-filled.e-float-input.e-control-wrapper.e-autofill.e-warning input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-bigger .e-filled.e-float-input.e-control-wrapper.e-autofill.e-warning input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-bigger.e-filled.e-float-input.e-control-wrapper.e-autofill.e-warning input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-small .e-filled.e-float-input.e-control-wrapper.e-autofill.e-warning input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-small.e-filled.e-float-input.e-control-wrapper.e-autofill.e-warning input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-bigger .e-filled.e-float-input.e-small.e-control-wrapper.e-autofill.e-warning input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-bigger.e-small .e-filled.e-float-input.e-control-wrapper.e-autofill.e-warning input:not(:focus):-webkit-autofill~label.e-float-text,
  .e-filled.e-float-input.e-bigger.e-small.e-control-wrapper.e-autofill.e-warning input:not(:focus):-webkit-autofill~label.e-float-text {
    @if $input-skin-name == 'material' {
      color: $input-warning-color;
    }
  }
